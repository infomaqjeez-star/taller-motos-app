...
export async function POST(request: NextRequest) {
  try {
    ...
    // Validar firma del webhook (implementar según docs de MeLi)
...
export async function GET(request: NextRequest) {
  // Mercado Libre envía un challenge para verificar el webhook
