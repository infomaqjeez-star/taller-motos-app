...
function AppJeezInner() {
  ...
  // Escuchar evento cuando se responde una pregunta desde /mensajes
  useEffect(() => {
    const handleQuestionAnswered = () => {
      console.log('[Dashboard] Pregunta respondida, actualizando...');
      load();
    };
  ...
  // ✅ Polling automático DESACTIVADO temporalmente para debug
  const { isRefreshing, manualRefresh } = useAutoRefresh(
    load,
    false, // DESACTIVADO - causando refrescos constantes
    180000
  );
